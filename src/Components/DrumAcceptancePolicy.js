...
library.add(faXmark)
const DrumAcceptancePolicy = ({ setOpenPolicy}) => {
  ...
  return (
    <div className="policyModal">
      ...
      <div
        className="policyModalContent wrapper"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
          ...
          <ul>
            <li>
              <p>
                ...
                residue from classes 3, 4.1, 5, 6.1, 8 or 9. Dangerous goods
                from classes 1, 4.3, 6.2, 7 or packing group 1 of any class are
                not accepted for reconditioning.
              </p>
            </li>
            <li>
              <p>
                These drums are "empty" as defined in provincial environmental
                regulations and have been properly prepared for transportation
                under regulations of Transport Canada.
              </p>
            </li>
          </ul>
        </div>
